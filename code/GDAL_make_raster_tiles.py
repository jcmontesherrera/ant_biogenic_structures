# Authors: JCMontesHerrera & Making Sense Remotely

#To-do:
#Create file capable of loading the polygons exported within a dir, glob i guess
#Remember multiple polygon export requires changing out_fp adding polygon_label after / e.g. "EF-12-Tiles/1_"
